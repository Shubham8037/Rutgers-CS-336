...
<%
    ...
    if (rs.next()) {
    	out.println("Username exists, please try another <a href='NewCustRepAcc.jsp'>try again</a>");
    } else {
    	int x = stmt.executeUpdate("insert into customerrep (repuser, reppass) values('" +userid+ "', '" +pass+ "')");
